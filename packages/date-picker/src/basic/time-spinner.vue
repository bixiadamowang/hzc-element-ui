...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'hzc-element-ui/src/utils/date-util';
  import ElScrollbar from 'hzc-element-ui/packages/scrollbar';
  import RepeatClick from 'hzc-element-ui/src/directives/repeat-click';
